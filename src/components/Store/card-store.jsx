  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr_1fr] gap-4 bg-white rounded shadow-lg border border-gray-300 p-4">
      <div className="flex justify-center items-center">
        <img className="object-cover rounded-lg w-40 md:w-48 h-28 md:h-32" src="https://storage.googleapis.com/t16t_assets/gyn_prod_logo.jpg" alt="Technology Acquisitions 2021" width={50} height={50} layout="intrinsic" />
      </div>
