  ...
  return cookieData ? (
    <div>
          <div className="flex gap-10 flex-col items-start my-10 p-9 rounded-lg bg-[#EBEBEB] max-w-screen-lg m-auto">
            ...
            <button className="bg-primary py-5 px-12 text-center rounded-lg flex flex-col items-center text-white shadow-lg hover:bg-primary-dark transition">
                <h6 className="flex items-center text-lg">
                <Image width={200} height={200} src="Vector.svg" alt="Balance Icon" className="w-6 h-6 mr-2" /> Balance
                </h6>
            ...
            <p className="mt-3 text-black text-sm opacity-50 font-bold ">Pick Method To pup Your Wallet</p>
...
{/* 
            ...
            <Link href='wallet/PaymentProcess' className="p-2 flex flex-col items-center justify-center rounded-lg shadow-sm hover:bg-gray-100 transition" style={{ boxShadow: "0px 2px 2px 0px #00000047" }}>
                <button >
                <Image width={100} height={100} src="Passport.svg" alt="Cash" className="" />
                </button>
                <h4 className="text-md font-medium">Voucher</h4>
            </Link>
