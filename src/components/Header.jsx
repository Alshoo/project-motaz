    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 md:flex justify-center">
        <nav
          ...
          <div
            className={`${isScrolled ?
              "hidden md:flex flex-1 justify-center space-x-1" :
              " hidden md:flex flex-1 justify-center space-x-4"
              }`}
          >
            <Link
              href="/home"
            ...
            {userData ? (
              ...
              <div className="flex space-x-2">
                <Link href="/Login" style={{
                  ...
                  <button
                    className={`${isScrolled ?
                      "text-primary flex items-center px-2 py-1 border border-primary rounded-[30px] transition-colors duration-500 hover:bg-primary hover:text-white" :
                      "text-primary flex items-center px-4 py-2 border border-primary rounded-[30px] transition-colors duration-500 hover:bg-primary hover:text-white"
                      }`}
                  >
                ...
                <Link href="/Create" style={{
                  ...
                  <button
                    className={`${isScrolled ?
                      "flex items-center px-2 py-1 bg-primary text-white rounded-[30px] transition-colors duration-500 hover:bg-transparent hover:text-primary hover:border border border-primary" :
                      "flex items-center px-4 py-2 bg-primary text-white rounded-[30px] transition-colors duration-500 hover:bg-transparent hover:text-primary hover:border border border-primary"
                      }`}
                  >
