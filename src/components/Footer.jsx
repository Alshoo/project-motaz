...
function Footer() {
  return (
    <footer className="bg-black w-full mt-auto absolute bottom-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex justify-end items-end">
            <ul className="flex gap-4 text-xs sm:text-sm">
              <li>
                <a href="mailto:motazmcqs@gmail.com" className="text-white">
                  motazmcqs@gmail.com
                </a>
              </li>
              <li>
                <a href="tel:+218915227857" className="text-white">
                  +218915227857
                </a>
              </li>
            </ul>
